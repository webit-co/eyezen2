<dl class="list">
	...
	<dt class="machinery_hide_button">
		<div class="more_box mt30 mb20">
			<div id="machinery_open" class="button1">
				MORE
			</div>
		</div>
	</dt>
    <dt class="machinery_hide">レンズ</dt>
    ...
    <dt class="machinery_hide">モニター</dt>
	    <dd class="machinery_hide">
	    	small HD  ５ｲﾝﾁ（2台）<br>
			small HD  ７ｲﾝﾁ（2台）<br>
			sony 17インチ<br>
			sony有機EL PVM-741 (3台)<br>
			BON 5インチ<br>
			TV logic 5.5” FHD<br>
			TV logic 5インチ VFM-055A<br>
...
<dl class="list">
    <dt class="machinery_hide">ドローン</dt>
    	<dd class="machinery_hide">
    		...
    		DJI INSPIRE 2 (X4sレンズ）<br>
			DJI INSPIRE 1 (X5レンズ）<br>
      DJI MAVIC 2 PRO<br>
      DJI Mavic 3 Cine
    	</dd>
	<dt class="machinery_hide">特機</dt>
    	<dd class="machinery_hide">
			...
			SWIFT JIB50 （ジブ）<br>
			MICRO DOLLY HOLLYWOOD (簡易レール）<br>
